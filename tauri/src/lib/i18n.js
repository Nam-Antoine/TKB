...
const STRINGS = {
  en: {
    ...
    lessonsLeftSummary: '{left} of {total} lessons left',
    subjectsRemaining: '{n} of {m} subjects still running',
    allDone: 'All lessons done 🎉',
    progressOf: '{done}/{total}',
    notesTitle: 'Notes for this day',
    notesPlaceholder: 'Jot down anything for this day — exam room, revision plan, deadlines, reminders…',
    noteSaving: 'Saving…',
    noteSaved: 'Saved',
    noteSaveFailed: "Couldn't save",
    session: 'Session',
    fDate: 'Date',
    fTime: 'Time',
    fRoom: 'Room',
  ...
  vi: {
    ...
    lessonsLeftSummary: 'Còn {left}/{total} buổi học',
    subjectsRemaining: 'Còn {n}/{m} môn đang học',
    allDone: 'Đã học hết 🎉',
    progressOf: '{done}/{total}',
    notesTitle: 'Ghi chú cho ngày này',
    notesPlaceholder: 'Ghi lại bất cứ điều gì cho ngày này — phòng thi, kế hoạch ôn tập, hạn nộp, nhắc nhở…',
    noteSaving: 'Đang lưu…',
    noteSaved: 'Đã lưu',
